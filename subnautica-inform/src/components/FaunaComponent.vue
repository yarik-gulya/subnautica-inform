        ...
        const objects = ref([
            {
                ...
                image: require('../images/Peeper.png')
            },
            {
                id: 2,
                name: 'Реджинальд',
                ...
                image: require('../images/Reginald.png')
            },
            {
                id: 3,
                name: 'Личинка лави',
                ...
                image: require('../images/Lava_Larva.png')
            },
            {
                id: 4,
                name: 'Гіпнотизер',
                ...
                image: require('../images/Mesmer.png')
            },
            {
                id: 5,
                name: 'Кальмаро-краб',
                ...
                image: require('../images/Crabsquid.png')
            },
            {
                id: 6,
                name: 'Левиафан-жнець',
                ...
                image: require('../images/Reaper_Leviathan.png')
            },
        ])
